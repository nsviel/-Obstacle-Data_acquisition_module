...
# LiDAR connection
def test_connection():
    l1_ip = param_capture.state_capture["lidar_1"]["ip"]
    l2_ip = param_capture.state_capture["lidar_2"]["ip"]
    l1_connected = param_capture.state_capture["lidar_1"]["connected"]
    l2_connected = param_capture.state_capture["lidar_2"]["connected"]
    ...
    param_capture.state_capture["lidar_1"]["connected"] = l1_ok
    param_capture.state_capture["lidar_2"]["connected"] = l2_ok
...
# LiDAR 1 motor
def start_l1_motor():
    ip = param_capture.state_capture["lidar_1"]["ip"]
    speed = param_capture.state_capture["lidar_1"]["speed"]
    data = {'rpm': str(speed),}
...
# LiDAR 2 motor
def start_l2_motor():
    ip = param_capture.state_capture["lidar_2"]["ip"]
    speed = param_capture.state_capture["lidar_2"]["speed"]
    data = {'rpm': speed,}
    if(send_lidar_parameter(ip, data)):
